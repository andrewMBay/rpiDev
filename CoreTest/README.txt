...
The builder scripts will scan, build, then watch the application directory for changes and re-build as needed. Each builder needs it's own terminal/process to run in. Terminal's working directory must be the parent folder for each project, i.e. same folder as the "runBuilder.sh" scripts.
