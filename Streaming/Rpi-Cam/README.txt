...
-Uses some kind of framework to take H264 frames from the camera and box them into JPEG
...
-Takes boxed JPEGs and saves them to /dev/shm/mjpeg/cam.jpg, which is simlinked to /var/www/html
